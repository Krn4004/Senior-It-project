...
Food Database Management: Create a scalable searchable database of food items with portion sizes and nutritional values
...
Obejective 
Structure 
Frontend , Backend, AI / Machine learning Components , Database, DevOps/ CI-CD
